...
public class Equipment {
    ...
    public Equipment(String name, int mImageResource, double Id, double Str, double Agi, double Int, double Luc) {
        this.Id = Id;
        this.Str = Str;
        this.Agi = Agi;
        this.Int = Int;
    ...
    public static class Weapon extends Equipment {
        ...
        public Weapon(String name, int mImageResource, double Id, double Str, double Agi, double Int, double Luc, double dmg) {
            super(name, mImageResource, Id, Str, Agi, Int, Luc);
            this.Dmg = dmg;
        }
    ...
    public static class Armour extends Equipment {
        ...
        public Armour(String name, int mImageResource, double Id, double Str, double Agi, double Int, double Luc, String typeArmour, double armor) {
            super(name, mImageResource, Id, Str, Agi, Int, Luc);
